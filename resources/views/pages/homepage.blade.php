                    ...
                    <div class="product-showcase" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <div class="product-grid">
                            <div class="product-mini" data-aos="zoom-in" data-aos-delay="400">
                                <img src="{{ 'niceshop/assets/img/product/scopus.png' }}" alt="Product"
                                    class="img-fluid">
                                <span class="mini-price">$89</span>
                            </div>
                            <div class="product-mini" data-aos="zoom-in" data-aos-delay="500">
                                <img src="{{ 'niceshop/assets/img/product/grammarly.png' }}" alt="Product"
                                    class="img-fluid">
                        ...
                        <div class="category-featured" data-aos="fade-right" data-aos-delay="200">
                            <div class="category-image image-scopcus">
                                <div class="d-flex justify-content-center align-items-center"
                                    ...
                                    <div class="card border-0 card-scopus"
                                        style="border-radius: 20px; overflow: hidden; margin: 30px; box-shadow: -8px 8px 20px rgba(255, 165, 0, 0.5);">
                                        <img src="{{ 'niceshop/assets/img/product/scopus.png' }}"
                                            alt="Scopus Lisensi & AI" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="category-content">
                                ...
                                <p class="text-scopus" style="text-align: justify; margin-right: 5px; font-size: 12px;">
                                    Akun Scopus Lisensi & Scopus AI memberi akses ke database jurnal ilmiah terbesar
                                    dengan
                                ...
                                <a href="#" class="btn-shop">Explore Products <i
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-6">
                                <div class="category-card cat-men" data-aos="fade-up" data-aos-delay="300">
                                    <div class="category-image">
                                        <img src="{{ 'niceshop/assets/img/product/grammarly.png' }}" alt="Men's Fashion"
                                            class="img-fluid">
                                    </div>
                                    <div class="category-content">
                            ...
                            <div class="col-xl-6">
                                <div class="category-card cat-kids" data-aos="fade-up" data-aos-delay="400">
                                    <div class="category-image">
                                        <img src="{{ 'niceshop/assets/img/product/quillbot.png' }}"
                                            alt="Kid's Fashion" class="img-fluid">
                                    </div>
                                    <div class="category-content">
                            ...
                            <div class="col-xl-6">
                                <div class="category-card cat-cosmetics" data-aos="fade-up" data-aos-delay="500">
                                    <div class="category-image">
                                        <img src="{{ 'niceshop/assets/img/product/consensus.png' }}" alt="Cosmetics"
                                            class="img-fluid">
                                    </div>
                                    <div class="category-content">
                            ...
                            <div class="col-xl-6">
                                <div class="category-card cat-accessories" data-aos="fade-up" data-aos-delay="600">
                                    <div class="category-image">
                                        <img src="{{ 'niceshop/assets/img/product/gamma.png' }}" alt="Accessories"
                                            class="img-fluid">
                                    </div>
                                    <div class="category-content">
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row featured-products-row" data-aos="fade-up" data-aos-delay="500">
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="product-showcase">
                            <div class="product-image">
                                <img src="{{ 'niceshop/assets/img/product/product-5.webp' }}" alt="Featured Product"
                                    class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="150">
                        <div class="product-showcase">
                            <div class="product-image">
                                <img src="{{ 'niceshop/assets/img/product/product-7.webp' }}" alt="Featured Product"
                                    class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="product-showcase">
                            <div class="product-image">
                                <img src="{{ 'niceshop/assets/img/product/product-11.webp' }}" alt="Featured Product"
                                    class="img-fluid">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="250">
                        <div class="product-showcase">
                            <div class="product-image">
                                <img src="{{ 'niceshop/assets/img/product/product-1.webp' }}" alt="Featured Product"
                                    class="img-fluid">
                            ...
                            <div class="product-item">
                                <div class="product-image">
                                    ...
                                    <img src="{{ asset('storage/img/product/' . $item->image) }}"
                                        alt="{{ $item->nama_akun }}" class="img-fluid" loading="lazy">
                        ...
                        <div class="product-category">
                            ...
                            <div class="product-list">
                                <div class="product-card">
                                    <div class="product-image">
                                        <img src="{{ 'niceshop/assets/img/product/product-1.webp' }}"
                                            ...
                                            <main class="main">
                                                            ...
                                                            <div class="hero-content">
                                                                <div class="content-wrapper" data-aos="fade-up"
                                                                    ...
                                                                    <div class="hero-actions" data-aos="fade-up"
                                                                        data-aos-delay="200">
                                                                        <a href="#products" class="btn-primary">Shop
                                                                            Now</a>
                                                                        <a href="#categories"
                                                                            class="btn-secondary">Browse Categories</a>
                                                                    </div>
                                                        ...
                                                        <div class="hero-visuals">
                                                            <div class="product-showcase" data-aos="fade-left"
                                                                ...
                                                                @forelse($banners as $banner)
                                                                    <div class="product-card featured">
                                                                        <img style="width: 100%;"
                                                                            src="{{ asset('storage/img/banners/' . $banner->gambar) }}"
                                                                ...
                                                                <div class="product-grid">
                                                                    <div class="product-mini" data-aos="zoom-in"
                                                                        data-aos-delay="400">
                                                                        <img src="{{ 'niceshop/assets/img/product/scopus.png' }}"
                                                                    ...
                                                                    <div class="product-mini" data-aos="zoom-in"
                                                                        data-aos-delay="500">
                                                                        <img src="{{ 'niceshop/assets/img/product/grammarly.png' }}"
                                                                            alt="Product" class="img-fluid">
                                                                        <span class="mini-price">$149</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="floating-elements">
                                                                <div class="floating-icon cart" data-aos="fade-up"
                                                                    data-aos-delay="600">
                                                                    <i class="bi bi-cart3"></i>
                                                                    <span class="notification-dot">3</span>
                                                                </div>
                                                                <div class="floating-icon wishlist" data-aos="fade-up"
                                                                    data-aos-delay="700">
                                                                    <i class="bi bi-heart"></i>
                                                                </div>
                                                                <div class="floating-icon search" data-aos="fade-up"
                                                                    data-aos-delay="800">
                                                                    <i class="bi bi-search"></i>
                                                                </div>
                                                            </div>
                                                ...
                                                <section id="promo-cards" class="promo-cards section">
                                                    <div class="container" data-aos="fade-up" data-aos-delay="100">
                                                        <div class="row gy-4">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="category-featured" data-aos="fade-right"
                                                                    data-aos-delay="200">
                                                                    <div class="category-image image-scopcus">
                                                                        <div class="d-flex justify-content-center align-items-center"
                                                                            style="min-height: 500px;">
                                                                            <div class="border-0 card card-scopus"
                                                                                style="border-radius: 20px; overflow: hidden; margin: 30px; box-shadow: -8px 8px 20px rgba(255, 165, 0, 0.5);">
                                                                                <img src="{{ 'niceshop/assets/img/product/scopus.png' }}"
                                                                    ...
                                                                    <div class="category-content">
                                                                        ...
                                                                        <h2>Scopus Lisensi & Scopus AI</h2>
                                                                        <p class="text-scopus"
                                                                            style="text-align: justify; margin-right: 5px; font-size: 12px;">
                                                                            Akun Scopus Lisensi & Scopus AI memberi
                                                                            akses ke database jurnal ilmiah terbesar
                                                                            dengan
                                                                            dukungan AI untuk pencarian, analisis, dan
                                                                            rekomendasi publikasi. Solusi ideal bagi
                                                                            peneliti, akademisi, dan profesional yang
                                                                            membutuhkan sumber ilmiah terkini.</p>
                                                                        <a href="#" class="btn-shop">Explore
                                                                            Products <i
                                                                                class="bi bi-arrow-right"></i></a>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row gy-4">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="category-card cat-cosmetics"
                                                                            ...
                                                                            <div class="category-image">
                                                                                <img src="{{ 'niceshop/assets/img/product/consensus.png' }}"
                                                                                    alt="Cosmetics" class="img-fluid">
                                                                            </div>
                                                                            <div class="category-content">
                                                                                <h4>Consensus Premium</h4>
                                                                                <a href="#"
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="category-card cat-accessories"
                                                                            data-aos="fade-up" data-aos-delay="600">
                                                                            <div class="category-image">
                                                                                <img src="{{ 'niceshop/assets/img/product/gamma.png' }}"
                                                                                    alt="Accessories"
                                                                                    class="img-fluid">
                                                                            </div>
                                                                            <div class="category-content">
                                                ...
                                                <section id="call-to-action" class="call-to-action section">
                                                    <div class="container" data-aos="fade-up" data-aos-delay="100">
                                                        <div class="row">
                                                            <div class="mx-auto col-lg-8">
                                                                <div class="text-center main-content"
                                                                    ...
                                                                    <div class="offer-badge" data-aos="fade-down"
                                                                        data-aos-delay="250">
                                                                        <span class="limited-time">Limited Time</span>
                                                                        <span class="offer-text">50% OFF</span>
                                                                    </div>
                                                                    ...
                                                                    <h2 data-aos="fade-up" data-aos-delay="300">
                                                                        Exclusive Flash Sale</h2>

                                                                    <p class="subtitle" data-aos="fade-up"
                                                                        data-aos-delay="350">Don't miss out on our
                                                                        biggest sale of the year. Premium quality
                                                                        products at unbeatable prices for the next 48
                                                                        hours only.</p>

                                                                    <div class="countdown-wrapper" data-aos="fade-up"
                                                                        data-aos-delay="400">
                                                                        <div class="countdown d-flex justify-content-center"
                                                                            data-count="2025/12/31">
                                                                            <div>
                                                                                <h3 class="count-days"></h3>
                                                                                <h4>Days</h4>
                                                                            </div>
                                                                    ...
                                                                    <div class="action-buttons" data-aos="fade-up"
                                                                        data-aos-delay="450">
                                                                        <a href="#" class="btn-shop-now">Shop
                                                                            Now</a>
                                                                        <a href="#" class="btn-view-deals">View
                                                                            All Deals</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row featured-products-row" data-aos="fade-up"
                                                            data-aos-delay="500">
                                                            <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                data-aos-delay="100">
                                                                <div class="product-showcase">
                                                                    <div class="product-image">
                                                                        <img src="{{ 'niceshop/assets/img/product/product-5.webp' }}"
                                                            ...
                                                            <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                ...
                                                                <div class="product-showcase">
                                                                    <div class="product-image">
                                                                        <img src="{{ 'niceshop/assets/img/product/product-7.webp' }}"
                                                                            alt="Featured Product" class="img-fluid">
                                                                        <div class="discount-badge">-60%</div>
                                                                    </div>
                                                                    <div class="product-details">
                                                            ...
                                                            <div class="col-lg-3 col-md-6" data-aos="zoom-in"
                                                                ...
                                                                <div class="product-showcase">
                                                                    <div class="product-image">
                                                                        <img src="{{ 'niceshop/assets/img/product/product-11.webp' }}"
                                                                            alt="Featured Product" class="img-fluid">
                                                                        <div class="discount-badge">-35%</div>
                                                                    </div>
                                                                    <div class="product-details">
