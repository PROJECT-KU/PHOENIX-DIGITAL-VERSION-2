<div>
    <div class="mb-2 d-flex align-items-center justify-content-between">
        <h3>Pesan Masuk Pelanggan</h3>
        @php
        $breadcrumbs = [['name' => 'Beranda', 'url' => route('admin.dashboard')], ['name' => 'Data Pesan Masuk Pelanggan']];
        @endphp
                        ...
                        <tr class="{{ is_null($item->read_at) ? 'table-warning' : '' }}">
                            ...
                            <td>
                                <div class="gap-2 d-flex justify-content-center">
                                    <a wire:navigate href="{{ route('admin.customer-message.detail', $item) }}"
                                        class="text-black btn btn-sm btn-warning" title="Detail">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <button type="button" wire:click="$dispatch('will-delete-customer-message-data', {{$item}})"
