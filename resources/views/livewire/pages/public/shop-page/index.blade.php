<main class="main">
    ...
    <style>
        ...
        .sf-papan, .sk-kartu, .shp-empty, .ph-pagination {
    ...
    <!-- Page Title -->
    {{-- Kepala halaman rata kiri dengan remah roti di kanan — bentuk yang sama
         dengan halaman detail produk dan halaman lain yang memakai kartu judul
         bersama. Versi rata tengah sempat dicoba dan dikembalikan atas
         permintaan pemilik: seragam antarhalaman lebih penting di sini. --}}
