...
<main class="legal-page lg-lebar">
    ...
    <div class="container">
        <div class="legal-card">
            @php
                // Urutannya HARUS sama dengan urutan blok di bawah; id-nya fq-1..fq-7.
                $pasal = [
                    'Bagaimana cara memesan?',
                    'Metode pembayaran & keamanan',
                    'Berapa lama pesanan diproses?',
                    'Apakah akun bergaransi?',
                    'Batas perangkat per akun',
                    'Kebijakan pengembalian dana',
                    'Bagaimana data saya dijaga?',
                ];
            @endphp
            ...
            <div class="legal-block legal-highlight" id="fq-2">
            ...
            <div class="legal-block legal-highlight" id="fq-5">
