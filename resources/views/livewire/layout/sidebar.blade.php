...
<div id="sidebar" wire:poll.30s.keep-alive>
    {{-- Pembawa hitungan badge (total + per kategori). Diperbarui tiap sidebar
         re-render/poll. Dipakai untuk:
         - badge di judul tab: "(N) lemon"
         - popup notifikasi OS (seperti WhatsApp) saat suatu kategori bertambah.
         wire:poll di atas menjaga hitungan tetap segar meski admin sedang di
         aplikasi/tab lain (keep-alive), sehingga popup tetap muncul. --}}
