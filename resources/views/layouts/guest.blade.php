                ...
                <div class="megamenu-content tab-content">
                    ...
                    <div class="product-grid">
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-1.webp' }}" alt="Featured Product" loading="lazy">
                        </div>
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-2.webp' }}" alt="Featured Product" loading="lazy">
                        </div>
                        <div class="product-info">
                          <h5>Smart Watch</h5>
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-3.webp' }}" alt="Featured Product" loading="lazy">
                        </div>
                        <div class="product-info">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-4.webp' }}" alt="Featured Product" loading="lazy">
                        </div>
                        <div class="product-info">
                  ...
                  <div class="tab-pane fade" id="new-content-1862" role="tabpanel" aria-labelledby="new-tab">
                    <div class="product-grid">
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-5.webp' }}" alt="New Arrival" loading="lazy">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-6.webp' }}" alt="New Arrival" loading="lazy">
                          <span class="badge-new">New</span>
                        </div>
                        <div class="product-info">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-7.webp' }}" alt="New Arrival" loading="lazy">
                          <span class="badge-new">New</span>
                        </div>
                        <div class="product-info">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-8.webp' }}" alt="New Arrival" loading="lazy">
                          <span class="badge-new">New</span>
                        </div>
                        <div class="product-info">
                  ...
                  <div class="tab-pane fade" id="sale-content-1862" role="tabpanel" aria-labelledby="sale-tab">
                    <div class="product-grid">
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-9.webp' }}" alt="Sale Product" loading="lazy">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-10.webp' }}" alt="Sale Product" loading="lazy">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-11.webp' }}" alt="Sale Product" loading="lazy">
                      ...
                      <div class="product-card">
                        <div class="product-image">
                          <img src="{{ 'niceshop/assets/img/product/product-12.webp' }}" alt="Sale Product" loading="lazy">
                ...
                <div class="megamenu-content tab-content">
                    ...
                    <div class="category-layout">
                      ...
                      <div class="featured-section">
                        <div class="featured-image">
                          <img src="{{ 'niceshop/assets/img/product/product-f-1.webp' }}" alt="Women's Heels Collection">
                  ...
                  <div class="tab-pane fade" id="mens-content-1883" role="tabpanel" aria-labelledby="mens-tab">
                    <div class="category-layout">
                      ...
                      <div class="featured-section">
                        <div class="featured-image">
                          <img src="{{ 'niceshop/assets/img/product/product-m-4.webp' }}" alt="Men's Footwear Collection">
                          <div class="featured-content">
                  ...
                  <div class="tab-pane fade" id="kids-content-1883" role="tabpanel" aria-labelledby="kids-tab">
                    <div class="category-layout">
                      ...
                      <div class="featured-section">
                        <div class="featured-image">
                          <img src="{{ 'niceshop/assets/img/product/product-9.webp' }}" alt="Kids' New Arrivals">
                          <div class="featured-content">
